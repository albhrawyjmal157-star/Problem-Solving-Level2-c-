...
void SumOf2Arrays(int Numbers[100], int Numbers1[100], int Sum[100], int Length)
{
    for (int i = 0; i < Length; i++)
    {
        Sum[i] = Numbers[i] + Numbers1[i];
    }
}
...
int main()
{
    ...
    int Numbers[100] = {}, Numbers1[100] = {}, Sum[100] = {};
    ...
    ReadElmentOfArray(Numbers1, Length);
    cout << " \n\nElements  Array : \n";
    PrintElmentOfArray(Numbers1, Length);

    SumOf2Arrays(Numbers, Numbers1, Sum, Length);
    cout << " \n\nElements Sum Of 2 Arrays : \n";
    PrintElmentOfArray(Sum, Length);
