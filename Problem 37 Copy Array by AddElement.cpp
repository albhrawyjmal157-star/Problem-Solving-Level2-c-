...
void CopyArrayElement(int Numbers[100], int CopyArrayNumbers[100], int Length, int &Counter)
{
    for (int i = 0; i < Length; i++)
    {
...
int main()
{
    ...
    CopyArrayElement(Numbers, CopyArrayNumbers, Length, Counter);
    cout << "\nCopy By Add Element  Array : " << endl;
